...
> Community fork of [standardnotes/app](https://github.com/standardnotes/app), rebranded for independent self-hosting. "Standard Notes" remains a trademark of its respective owners; this project is not affiliated with or endorsed by them.

Regular Notes is an end-to-end encrypted note-taking app for digitalists and professionals. Capture your notes, files, and life’s work all in one secure place.
...
3. Download Regular Notes on your devices.
...
4. You're all set. Regular Notes comes out of the box with end-to-end encrypted sync on all your devices.

### Publish a Blog

 Regular Notes is a dependable environment to do your most important work, including publishing your ideas to the world. Listed allows you to create an online publication with automatic email newsletters delivered to your readers, directly from Regular Notes.
